...
Shader "Ground"
{
	Properties
	{
		...
		[ASEBegin]_Ground_Normal("Ground_Normal", 2D) = "bump" {}
		_Mud_Normal("Mud_Normal", 2D) = "bump" {}
		_Ground_bc("Ground_bc", 2D) = "white" {}
		_Mud_bc("Mud_bc", 2D) = "white" {}
		_Mud_bc1("Mud_bc", 2D) = "white" {}
		_Ground_AoCurvatureMask("Ground_AoCurvatureMask", 2D) = "white" {}
		[ASEEnd]_intensity_Mask("intensity_Mask", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Ground_bc_ST;
			float4 _Mud_bc_ST;
			float4 _Mud_bc1_ST;
			float4 _Ground_Normal_ST;
			float4 _Mud_Normal_ST;
			float4 _Ground_AoCurvatureMask_ST;
			float _intensity_Mask;
			...
			#endif
			CBUFFER_END
			sampler2D _Ground_bc;
			sampler2D _Mud_bc;
			sampler2D _Mud_bc1;
			sampler2D _Ground_Normal;
			sampler2D _Mud_Normal;
			sampler2D _Ground_AoCurvatureMask;
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_Ground_bc = IN.ase_texcoord8.xy * _Ground_bc_ST.xy + _Ground_bc_ST.zw;
				float2 uv_Mud_bc = IN.ase_texcoord8.xy * _Mud_bc_ST.xy + _Mud_bc_ST.zw;
				float2 uv_Mud_bc1 = IN.ase_texcoord8.xy * _Mud_bc1_ST.xy + _Mud_bc1_ST.zw;
				float4 tex2DNode22 = tex2D( _Mud_bc1, uv_Mud_bc1 );
				float temp_output_21_0 = ( ( IN.ase_color.r * tex2DNode22.r ) * _intensity_Mask );
				float4 lerpResult19 = lerp( tex2D( _Ground_bc, uv_Ground_bc ) , tex2D( _Mud_bc, uv_Mud_bc ) , temp_output_21_0);
				
				float2 uv_Ground_Normal = IN.ase_texcoord8.xy * _Ground_Normal_ST.xy + _Ground_Normal_ST.zw;
				float2 uv_Mud_Normal = IN.ase_texcoord8.xy * _Mud_Normal_ST.xy + _Mud_Normal_ST.zw;
				float3 lerpResult17 = lerp( UnpackNormalScale( tex2D( _Ground_Normal, uv_Ground_Normal ), 1.0f ) , UnpackNormalScale( tex2D( _Mud_Normal, uv_Mud_Normal ), 1.0f ) , temp_output_21_0);
				
				float2 uv_Ground_AoCurvatureMask = IN.ase_texcoord8.xy * _Ground_AoCurvatureMask_ST.xy + _Ground_AoCurvatureMask_ST.zw;
				
				float3 Albedo = lerpResult19.rgb;
				float3 Normal = lerpResult17;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = 0.3;
				float Occlusion = tex2D( _Ground_AoCurvatureMask, uv_Ground_AoCurvatureMask ).r;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_Ground_bc = IN.ase_texcoord4.xy * _Ground_bc_ST.xy + _Ground_bc_ST.zw;
				float2 uv_Mud_bc = IN.ase_texcoord4.xy * _Mud_bc_ST.xy + _Mud_bc_ST.zw;
				float2 uv_Mud_bc1 = IN.ase_texcoord4.xy * _Mud_bc1_ST.xy + _Mud_bc1_ST.zw;
				float4 tex2DNode22 = tex2D( _Mud_bc1, uv_Mud_bc1 );
				float temp_output_21_0 = ( ( IN.ase_color.r * tex2DNode22.r ) * _intensity_Mask );
				float4 lerpResult19 = lerp( tex2D( _Ground_bc, uv_Ground_bc ) , tex2D( _Mud_bc, uv_Mud_bc ) , temp_output_21_0);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_Ground_bc = IN.ase_texcoord2.xy * _Ground_bc_ST.xy + _Ground_bc_ST.zw;
				float2 uv_Mud_bc = IN.ase_texcoord2.xy * _Mud_bc_ST.xy + _Mud_bc_ST.zw;
				float2 uv_Mud_bc1 = IN.ase_texcoord2.xy * _Mud_bc1_ST.xy + _Mud_bc1_ST.zw;
				float4 tex2DNode22 = tex2D( _Mud_bc1, uv_Mud_bc1 );
				float temp_output_21_0 = ( ( IN.ase_color.r * tex2DNode22.r ) * _intensity_Mask );
				float4 lerpResult19 = lerp( tex2D( _Ground_bc, uv_Ground_bc ) , tex2D( _Mud_bc, uv_Mud_bc ) , temp_output_21_0);
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_Ground_Normal = IN.ase_texcoord4.xy * _Ground_Normal_ST.xy + _Ground_Normal_ST.zw;
				float2 uv_Mud_Normal = IN.ase_texcoord4.xy * _Mud_Normal_ST.xy + _Mud_Normal_ST.zw;
				float2 uv_Mud_bc1 = IN.ase_texcoord4.xy * _Mud_bc1_ST.xy + _Mud_bc1_ST.zw;
				float4 tex2DNode22 = tex2D( _Mud_bc1, uv_Mud_bc1 );
				float temp_output_21_0 = ( ( IN.ase_color.r * tex2DNode22.r ) * _intensity_Mask );
				float3 lerpResult17 = lerp( UnpackNormalScale( tex2D( _Ground_Normal, uv_Ground_Normal ), 1.0f ) , UnpackNormalScale( tex2D( _Mud_Normal, uv_Mud_Normal ), 1.0f ) , temp_output_21_0);
...
/*ASEBEGIN
Version=18935
182;80.66667;1008.667;559;2200.275;1003.227;2.875555;True;True
Node;AmplifyShaderEditor.RangedFloatNode;13;-415.5535,80.06133;Inherit;False;Constant;_Float0;Float 0;3;0;Create;True;0;0;0;False;0;False;0.3;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;-942.5923,-216.8398;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;22;-1372.97,-214.5739;Inherit;True;Property;_Mud_bc1;Mud_bc;4;0;Create;True;0;0;0;False;0;False;-1;a4d9d3c734d902c44ad61f1a0043d4c6;3d7a6e7ea1037584298d5f980f401791;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;-676.7366,-252.4653;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;11;-490.478,-769.4507;Inherit;True;Property;_Ground_bc;Ground_bc;2;0;Create;True;0;0;0;False;0;False;-1;3d7a6e7ea1037584298d5f980f401791;3d7a6e7ea1037584298d5f980f401791;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;23;-421.8529,199.411;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;17;-180.2776,-139.4912;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;24;-1001.436,66.6566;Inherit;False;Property;_intensity_Mask;intensity_Mask;6;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;16;-534.6415,-124.4691;Inherit;True;Property;_Mud_Normal;Mud_Normal;1;0;Create;True;0;0;0;False;0;False;-1;a45769fbe0290cd4398cf944dc06d0f1;a45769fbe0290cd4398cf944dc06d0f1;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;10;-533.423,-313.9397;Inherit;True;Property;_Ground_Normal;Ground_Normal;0;0;Create;True;0;0;0;False;0;False;-1;a45769fbe0290cd4398cf944dc06d0f1;a45769fbe0290cd4398cf944dc06d0f1;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;19;-86.15845,-535.8207;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexColorNode;20;-1319.519,-442.6337;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;12;-544.9219,314.9777;Inherit;True;Property;_Ground_AoCurvatureMask;Ground_AoCurvatureMask;5;0;Create;True;0;0;0;False;0;False;-1;5b8775ef67b79b44497f77c3e3298d54;5b8775ef67b79b44497f77c3e3298d54;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;14;-516.3076,-529.6682;Inherit;True;Property;_Mud_bc;Mud_bc;3;0;Create;True;0;0;0;False;0;False;-1;e3f6745026946074fa3cdea104fae51f;3d7a6e7ea1037584298d5f980f401791;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=31C9853A612C31AE33ED9BB5D6EFE9FC5DB3E544