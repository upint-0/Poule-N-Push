...
Shader "Aura"
{
	Properties
	{
		...
		[ASEBegin]_GradientHeight("GradientHeight", Float) = 2
		[HDR]_Color("Color", Color) = (0.990566,0,0,0)
		_Distort_Normals("Distort_Normals", 2D) = "white" {}
		_DepthFade("DepthFade", Float) = 0
		[ASEEnd]_Modulation("Modulation", Float) = 0.77
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				float3 vertexPos22 = v.vertex.xyz;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float distanceDepth22 = abs( ( screenDepth22 - LinearEyeDepth( ase_screenPosNorm22.z,_ZBufferParams ) ) / ( _DepthFade ) );
				float2 texCoord18 = IN.ase_texcoord4.xy * float2( 5,1 ) + float2( 0,0 );
				float2 panner17 = ( 1.0 * _Time.y * float2( 0.15,0 ) + texCoord18);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = _Color.rgb;
				float Alpha = saturate( ( ( distanceDepth22 * ( 1.0 - saturate( ( WorldPosition.y / _GradientHeight ) ) ) ) - ( tex2D( _Distort_Normals, panner17 ).r * _Modulation ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float screenDepth22 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm22.xy ),_ZBufferParams);
				float distanceDepth22 = abs( ( screenDepth22 - LinearEyeDepth( ase_screenPosNorm22.z,_ZBufferParams ) ) / ( _DepthFade ) );
				float2 texCoord18 = IN.ase_texcoord3.xy * float2( 5,1 ) + float2( 0,0 );
				float2 panner17 = ( 1.0 * _Time.y * float2( 0.15,0 ) + texCoord18);
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float4 screenPos22 = IN.ase_texcoord;
				float4 ase_screenPosNorm22 = screenPos22 / screenPos22.w;
				ase_screenPosNorm22.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm22.z : ase_screenPosNorm22.z * 0.5 + 0.5;
				float screenDepth22 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm22.xy ),_ZBufferParams);
				float distanceDepth22 = abs( ( screenDepth22 - LinearEyeDepth( ase_screenPosNorm22.z,_ZBufferParams ) ) / ( _DepthFade ) );
				float3 ase_worldPos = IN.ase_texcoord1.xyz;
				float2 texCoord18 = IN.ase_texcoord2.xy * float2( 5,1 ) + float2( 0,0 );
				float2 panner17 = ( 1.0 * _Time.y * float2( 0.15,0 ) + texCoord18);
				
				surfaceDescription.Alpha = saturate( ( ( distanceDepth22 * ( 1.0 - saturate( ( ase_worldPos.y / _GradientHeight ) ) ) ) - ( tex2D( _Distort_Normals, panner17 ).r * _Modulation ) ) );
...
/*ASEBEGIN
Version=18935
398.4;526.4;966.4;545.4;1639.428;30.57521;1;True;False
Node;AmplifyShaderEditor.WorldPosInputsNode;11;-1220.009,406.0833;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;14;-1214.567,550.0836;Inherit;False;Property;_GradientHeight;GradientHeight;0;0;Create;True;0;0;0;False;0;False;2;0.33;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;18;-1309.367,102.6905;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;5,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleDivideOpNode;12;-1024.567,453.0833;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;24;-1426.371,448.5051;Inherit;False;Property;_DepthFade;DepthFade;3;0;Create;True;0;0;0;False;0;False;0;2.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;17;-1097.467,102.6905;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0.15,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SaturateNode;13;-902.5665,452.0833;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;23;-1462.771,312.0055;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;25;-745.1597,269.5085;Inherit;False;Property;_Modulation;Modulation;4;0;Create;True;0;0;0;False;0;False;0.77;0.47;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DepthFade;22;-1247.904,311.9839;Inherit;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;28;-770.1835,452.5138;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;16;-925.0154,73.07908;Inherit;True;Property;_Distort_Normals;Distort_Normals;2;0;Create;True;0;0;0;False;0;False;-1;5f208c04fa8b95740ad4e0bfbf771d64;5f208c04fa8b95740ad4e0bfbf771d64;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;-581.9781,172.3638;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;-565.8008,317.2933;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;26;-395.1841,173.363;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;10;-310.702,-6.178692;Inherit;False;Property;_Color;Color;1;1;[HDR];Create;True;0;0;0;False;0;False;0.990566,0,0,0;15.87451,1.782177,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;27;-243.7209,172.9389;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;Aura;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;638190147386033502;  Blend;0;0;Two Sided;0;638190151592266251;Cast Shadows;0;638190152536446996;  Use Shadow Threshold;0;0;Receive Shadows;0;638190152531185502;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=3A9EDF7339B82154A9AFFBD6AA9D20FD08F34EEA